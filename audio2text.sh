...
../src/dependancies/ffmpeg -y -i ../results/$1.3gp ../results/$1.wav
...
/Applications/Praat.app/Contents/MacOS/Praat ../src/praatfiles/praat-script-syllable-nuclei-v2file.praat -25 2 0.3 yes OPrimeAdministrator.app/Contents/Resources/backup $1.wav 2>&1 | tee -a praatresults.csv

echo "==Commiting new acoustic results"
../src/dependancies/git add praatresults.csv
