...
ffmpeg -y -i ../results/$1.3gp ../results/$1.wav
...
#praat ../src/praatfiles/praat-script-syllable-nuclei-v2file.praat -25 2 0.3 yes /home/gina/aublog/workspace/results $1.wav 2>&1 | tee -a praatresults.csv
