...
touch ../temp/$1_server.srt
echo ==Creating files _client, _server and .srt
cp ../temp/$1_client.srt $1.srt
...
ffmpeg -y -i ../temp/$1.amr ../temp/$1.wav

echo ==Running pocketsphinx
echo "0:00:00.020,0:00:00.020\nResults of the machine transcription will appear below when ready.\n\n" >> $1.srt
#170word gramamr: java -jar ..//sphinx4files/transcriber/bin/Transcriber.jar ../temp/$1.wav 2>&1 | tee -a $1.srt 
java -jar /home/gina/.groovy/lib/sphinx4/bin/LatticeDemo.jar ../temp/$1.wav | grep "I heard:" | sed -e 's/I heard://' 2>&1 | tee -a $1.srt 

cp $1.srt ../temp/$1_server.srt
#cd ..//testinstallpocketsphinx
#./hello_ps goforward.raw | grep Recognized >> ../../data/$1
#cd ../../data
...
praat ..//praatfiles/praat-script-syllable-nuclei-v2file.praat -25 2 0.3 yes /home/gina/aublog/workspace/temp $1.wav 2>&1 | tee -a praatresults.csv
